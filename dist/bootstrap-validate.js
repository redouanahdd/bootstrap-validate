! function (t, e) {
  ...
  return function (t) {
    ...
    t.exports = {
      ...
      hasTwoLetters: function (t) {
        return new RegExp(/^.*?[a-zA-Z]{1,}.*?[a-zA-Z]{1,}.*?$/i).test(t.value)
      },
      hasTwoNumbers: function (t) {
        return new RegExp(/^.*?[0-9]{1,}.*?[0-9]{1,}.*?$/i).test(t.value)
      },
      hasTwoSpecialChar: function (t) {
        return new RegExp(/^^.*?[\/\*\-\+\&\:\=\,\.\%\$\[\]\(\)\!\§\@\<\>]{1,}.*?[[\/\*\-\+\&\:\=\,\.\%\$\[\]\(\)\!\§\@\<\>]{1,}.*?$/).test(t.value)
      },
      url: function (t) {
    ...
    ! function (o) {
      ...
      h.abs = function () {
        ...
        var f, s, a, l, p, v = o.slice(),
          ...
          j = 0,
          O = i + (w.e = e.e - t.e) + 1;
        for (w.s = u, u = O < 0 ? 0 : O, v.unshift(0); m++ < f;) y.push(0);
        do {
          for (a = 0; a < 10; a++) {
          ...
          E[j++] = l ? a : ++a, y[0] && l ? y[m] = r[h] || 0 : y = [r[h]]
        } while ((h++ < x || y[0] !== g) && u--);
        return E[0] || 1 == j || (E.shift(), w.e--), j > O && b(w, i, n.RM, y[0] !== g), w
      }, h.eq = function (t) {
        return !this.cmp(t)
      }, h.gt = function (t) {
        return this.cmp(t) > 0
